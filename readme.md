...
[![My Skills](https://skillicons.dev/icons?i=autocad,java,python,go,rust,js,ts,html,css,nodejs,jquery,react,redux,babel,npm,pnpm,yarn,tailwind,vite,docker,k8s,maven,redis,mysql,mongodb,postgresql,sqlite,atom,redis,mysql,mongodb,kafka,nginx,rabbitmq,elasticsearch,figma,ps,git,github,gitlab,jenkins,fastapi,spring,hibernate,pycharm,idea,webstorm,clion,goland,rustrover,postman,obsidian,eclipse,vscode,visualstudio,md,atom,sublime,redhat,ubuntu,linux,apple,windows,aws,twitter,discord,stackoverflow,instagram,linkedin,gmail)](https://skillicons.dev)
