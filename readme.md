...
[![My Skills](https://skillicons.dev/icons?i=js,ts,html,css,nodejs,jquery,react,redux,babel,npm,pnpm,yarn,tailwind,vite,go,docker,k8s,java,maven,redis,mysql,mongodb,postgresql,sqlite,python,atom,redis,mysql,mongodb,kafka,nginx,rabbitmq,elasticsearch,figma,ps,git,github,gitlab,jenkins,fastapi,spring,hibernate,pycharm,idea,webstorm,postman,photoshop,figma,obsidian,eclipse,vscode,visualstudio,md,atom,sublime,redhat,ubuntu,linux,apple,windows,aws,twitter,discord,stackoverflow,instagram,linkedin,gmail)](https://skillicons.dev)
